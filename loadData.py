...
path_met = 'data/observations/MET_data'
...
path_nve = 'data/observations/NVE_data'
...
WRF1000_ts = pd.read_csv('data/WRF1000_ts.csv')
...
def defineStaticData(exp1='glac2006', exp2='noice_BT'):
    ...
    inpath = 'data/static/'#'../../WRF_general_output/static/'
...
def definePrecipData(years=years, season='SONDJFMAM', #months=months, start=start, end=end, 
    ...
    inpath = 'data/output_subsets/maps/precip'
...
def defineTempData(years=years, season='SONDJFMAM', #months=months, start=start, end=end, 
    ...
    inpath = 'data/output_subsets/maps/temp'
